...
export function ProfileView({ user, achievements }: ProfileViewProps) {
      ...
      >
        ...
        <div className="relative p-6 flex flex-col sm:flex-row items-start sm:items-center gap-5">
          ...
          <div className="flex-1">
            ...
            {user.bio && <p className="text-sm text-[#bbcabf] mt-2 max-w-md">{user.bio}</p>}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            {earnedAchs.length === 0 && (
              <div className="col-span-3 text-[#86948a] text-sm">No achievements earned yet.</div>
            )}
          </div>
        </div>
      </div>
